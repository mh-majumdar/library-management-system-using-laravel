                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="panel-heading text-center form_head">
                            <h2><b>NSTU</b>Central Library</h2>
                        </div>
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class=" custom_field form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                <div class="inner-addon right-addon">
                                    ...
                                    <input id="email" type="email" class="form-control" name="email"
                                        value="{{ old('email') }}" required placeholder="User e-Mail">
                                </div>
                                @if ($errors->has('email'))
                                    <span class="help-block">
                            ...
                            <div class="custom_field form-group">
                                <div class="inner-addon right-addon">
                                    ...
                                    <input id="registeration" type="text" class="form-control" name="reg_no" required
                            ...
                            <div class="custom_field form-group">
                                <div class="inner-addon right-addon">
                                    ...
                                    <input id="contact_no" type="text" class="form-control" name="contact" required
                                        placeholder="Contact">
                                </div>
                            </div>
