            ...
            <div class="col-md-4 col-md-offset-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="panel-heading text-center form_head">
                            <h2><b>Add</b> New Books</h2>
                        </div>
                            ...
                            <div class="custom_field form-group ">
                                <div class="inner-addon left-addon">
                                    ...
                                    <input id="title" type="text" class="form-control" name="title"
                                        value="{{ old('name') }}" required autofocus placeholder="Book Title">
                                </div>
                                <!--
                                            @if ($errors->has('name'))
    ...
    @endif
                            ...
                            <div class=" custom_field form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                <div class="inner-addon left-addon">
                                    ...
                                    <input id="edition" type="number" class="form-control" name="edition"
                                        value="{{ old('email') }}" required placeholder="Book Edition">
                                </div>
                            </div>
                            <!--
                                            @if ($errors->has('email'))
    ...
    @endif
                            ...
                            <div class="custom_field form-group">
                                <div class="inner-addon left-addon">
                                    ...
                                    <input id="booksAvail" type="number" class="form-control" name="booksAvail" required
